...
public class JobController 
{
	...
	public String savesignupform(@ModelAttribute Student studSave, Model model,
	    ...
	    // Add success message with user's name to model
	    String message = "Candidate " + studSave.getFirstname() + " has been registered successfully!";
	    model.addAttribute("successMessage", message);
	    model.addAttribute("userName", studSave.getFirstname());
	    
		
		model.addAttribute("jsCode", "swal('Registration Success!', firstname , 'success');");
