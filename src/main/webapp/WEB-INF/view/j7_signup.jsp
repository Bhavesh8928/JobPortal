				...
				<div class="myform form ">
					<form action="signupStudentData" method="post" name="login"
						...
						<div class="form-group">
							<input type="text" name="firstname" class="form-control my-input"
						...
						<div class="form-group">
							<input type="number" name="phone" id="phone" maxlength="10"
								required class="form-control my-input" placeholder="Phone">
						</div>
						<br> 
						<!-- TO AVOID ENTERING MORE THAN 10 DIGIT IN PHONE FIELD
						 -->
